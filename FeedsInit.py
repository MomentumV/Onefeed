...
RTparams = {
    ...
    'self_link': 'http://momentumv.github.io/Onefeed/RadioTheatre.xml',
...
RT = OneFeed.OnePlacePodCast(RTparams)
# RT.refresh(
...
TPparams = {
    ...
    'self_link': 'http://momentumv.github.io/Onefeed/TurningPoint.xml',
    'copyright': 'Focus on the Family',
    'feed_desc': desc,
    'feed_image_url': 'https://momentumv.github.io/Onefeed/Files/TP.jpg',
...
TP = OneFeed.OnePlacePodCast(TPparams)
